...
![image-20230413012633956](C:\Users\pc\AppData\Roaming\Typora\typora-user-images\image-20230413012633956.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2fb73a4ce63d4d5280e8694e1cb632a8.png)
...
![image-20230316182230733](C:\Users\pc\AppData\Roaming\Typora\typora-user-images\image-20230316182230733.png)
...
> [全文检索](https://so.csdn.net/so/search?q=全文检索&spm=1001.2101.3001.7020)是指对每一个词建立一个索引，指明该词在文章中出现的次数和位置。当查询时，根据事先建立的索引进行查找，并将查找的结果反馈给用户的检索方式。这个过程类似于通过字典中的检索字表查字的过程。
